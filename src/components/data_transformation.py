...
class DataTransformation:
    ...
    def initiate_data_transformation(self, trian_path, test_path):
        try:
            logging.info("Reading training and testing data started...")
            ...
            numerical_columns = train_df.drop(target_column_name, axis=1).select_dtypes(exclude=['object', 'bool']).columns
            ...
            utils = Utils()
            utils.save_object(file_path=self.data_transformation_config.preprocessor_obj_file_path, obj=preprocessing_obj)
